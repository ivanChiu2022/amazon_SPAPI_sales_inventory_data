...
# for special period
dateBack_end = 8 # for non SAT ending period , data will available after period end 3 days

dateBack_start = dateBack_end + 48 # change the no of days to define the report period.
...
dataStartTime = iso8601(wkBegan) #iso8601(wkBegan)
dataEndTime = iso8601(lastSat) #iso8601(lastSat)
